...
public class QuadrupedModel extends Model {
    ...
    public QuadrupedModel(int legSize) {
        head = new ModelPart(0, 0);
        head.addBox(-4.0f, -4.0f, -8.0f, 8, 8, 8, 0.0f);
        head.setPos(0.0f, 12.0f + 6.0f - legSize, -6.0f);
        
        body = new ModelPart(28, 8);
        body.addBox(-5.0f, -10.0f, -7.0f, 10, 16, 8, 0.0f);
        body.setPos(0.0f, 11.0f + 6.0f - legSize, 2.0f);
        
        leg1 = new ModelPart(0, 16);
        leg1.addBox(-2.0f, 0.0f, -2.0f, 4, legSize, 4, 0.0f);
        leg1.setPos(-3.0f, 18.0f + 6.0f - legSize, 7.0f);
        
        leg2 = new ModelPart(0, 16);
        leg2.addBox(-2.0f, 0.0f, -2.0f, 4, legSize, 4, 0.0f);
        leg2.setPos(3.0f, 18.0f + 6.0f - legSize, 7.0f);
        
        leg3 = new ModelPart(0, 16);
        leg3.addBox(-2.0f, 0.0f, -2.0f, 4, legSize, 4, 0.0f);
        leg3.setPos(-3.0f, 18.0f + 6.0f - legSize, -5.0f);
        
        leg4 = new ModelPart(0, 16);
        leg4.addBox(-2.0f, 0.0f, -2.0f, 4, legSize, 4, 0.0f);
        leg4.setPos(3.0f, 18.0f + 6.0f - legSize, -5.0f);
    }
